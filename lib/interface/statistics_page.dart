...
class Home extends StatefulWidget {
  ...
  final gridColor = Color.fromRGBO(76, 76, 76, 0.49);
  final titleColor = Color.fromRGBO(76, 76, 76, 0.49);
...
class _HomeState extends State<Home> {
                ...
                RadarChartData(
                  ...
                  getTitle: (index, angle) {
                    ...
                    switch (index) {
                      ...
                      case 1:
                        return RadarChartTitle(text: '実際の時間', angle: usedAngle);
                      default:
  ...
  List<PieChartSectionData> showingSections() {
    ...
    PieChartSectionData(
      ...
      // title: '見積時間<=実際の時間',
      title: '${num_small_predict().toInt()}人',
      titleStyle: TextStyle(
        fontSize: 15,
        fontWeight: FontWeight.bold,
        color: Colors.white,
